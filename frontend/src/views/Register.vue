            ...
            >
              ...
              <div class="pt-3">
                ...
                <div class="form-group">
                  ...
                  <div
                    class="error"
                    v-if="submitted && $v.form.user.first_name.$error"
                ...
                <div class="form-group">
                  ...
                  <div
                    class="error"
                    v-if="submitted && $v.form.user.last_name.$error"
                ...
                <div class="form-group">
                  ...
                  <div
                    class="error"
                    v-if="submitted && $v.form.user.password.$error"
                ...
                <div class="form-group">
                  ...
                  <div
                    class="error"
                    v-if="submitted && $v.form.user.password_confirmation.$error"
                  >Password and password confirmation don't match.</div>
                </div>
                <div
                  class="btn btn-primary float-right mt-5"
                  @click="nextStep()"
                >Next step <i class="pl-2 fa fa-arrow-right" /></div>
              </div>
            </div>
            <div
              ref="company form"
            ...
            >
              ...
              <div class="form-form pt-3">
                <div class="form-group">
                  ...
                  <div
                    class="error"
                    v-if="submitted && $v.form.company.name.$error"
                  >Please enter a valid company name.</div>
                </div>
                <div class="form-group">
                  ...
                  <div
                    class="error"
                    v-if="submitted && $v.form.company.industry_id.$error"
                  >Please select a valid industry.</div>
                </div>
                <div class="form-group">
                  <label>Country</label>
                  <div class="input-group mb-2 mr-sm-2">
                  ...
                  <div
                    class="error"
                    v-if="submitted && $v.form.company.country.$error"
                ...
                <div class="form-group">
                  ...
                  <div
                    class="error"
                    v-if="submitted && $v.form.company.city.$error"
                ...
                <div class="form-group">
                  ...
                  <div
                    class="error"
                    v-if="submitted && $v.form.company.vat.$error"
                  >Please enter a valid VAT.</div>
                </div>
                <div class="form-group pt-2">
                  ...
                  <div class="input-group mb-2 mr-sm-2">
                    ...
                    >
                      <option
                        ...
                        disabled=true
                        value="-1"
                      >How many employees does your company employ?</option>
                  ...
                  <div
                    class="error"
                    v-if="submitted && $v.form.company.total_employees.$error"
                  >Please select how many employees your company has.</div>
                </div>
                <div
                  class="btn btn-primary float-left mt-5"
                  @click="previousStep()"
                ><i class="pr-2 fa fa-arrow-left" /> Previous step</div>
                <div
                  class="btn btn-primary float-right mt-5"
                  @click="nextStep()"
                >Next step <i class="pl-2 fa fa-arrow-right" /></div>
